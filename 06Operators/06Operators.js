...
let comp1 = 6;
let comp2 = 7;
console.log("comp1 == comp2 is ", comp1 == comp2); // output = comp1 == comp2 is false
console.log("comp1 != comp2 is ", comp1 != comp2); // output = comp1 != comp2 is true
console.log("comp1 === comp2 is ", comp1 === comp2); // output = comp1 === comp2 is false
console.log("comp1 !== comp2 is ", comp1 !== comp2); // output = comp1 !== comp2 is true
console.log("comp1 > comp2 is ", comp1 > comp2); // output = comp1 > comp2 is false

// Logical Operators (Logic is checked)
let x = 5;
let y = 6;
console.log(x<y && x==5);
console.log(x>y || x==5);
